const positions = [
  ...
  {
    company: 'Laboratoire LISSI',
    position: 'Deep Learning & Computer Vision Research Intern',
    link: 'https://www.lissi.fr/home/',
    daterange: 'June 2019 - September 2019',
    points: [
      'Develop new Deep Learning model for Emotion Recognition from human face images.',
      'Implement Convolutional Neural Network architectures and Data augmentation technique as GAN and Geometric Transformations.',
      'Improve performance using Transfer Learning and Fine-tuning with  ResNet50 pretrained model.',
      'Publish a research paper that discusses the new solution with innovative results and achieve state-of-the-art performance.',
    ],
  },
  {
    company: 'Algérie Télécom',
    position: 'Web Developer Intern',
    link: 'https://www.algerietelecom.dz/fr/',
    daterange: 'June 2018 - August 2018',
    points: [
      'Front-end and back-end development.',
      'Identified and fixed website problems.',
      'Helped to achieve a consistent look by promoting uniform fonts and formatting issues.',
    ],
  },
];
